...
public class VerifyFailures extends HashMap<ITestResult, List<Throwable>> {

	private static final long serialVersionUID = 1L;

	public static VerifyFailures getFailures() {
		if (failures == null) {
			failures = new VerifyFailures();
		}
		return failures;
	}
	...
	private VerifyFailures() {
		super();
	}

	private static VerifyFailures failures;
}
